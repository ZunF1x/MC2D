...
public class EntityBlock extends Entity {
    ...
    public void update() {
        ...
        if (this.blockOnGround()) {
            this.game.getWorld().addBlock((int) Math.ceil(getLocation().getX()), (int) Math.floor(getLocation().getY()), this.block);
    ...
    @Override
    public void render() {
        this.block.render(this.getLocation(), this.game.getWorld().getChunk((int) (this.getLocation().getX() / 16D)).foliageColor);
    }
}
